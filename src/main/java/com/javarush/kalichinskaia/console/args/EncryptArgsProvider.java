...
import static com.javarush.kalichinskaia.console.AppMode.ENCRYPT_MODE;

public class EncryptArgsProvider implements ArgsProvider {

    @Override
    public List<String> get(Scanner scanner) {

        List<String> args = new ArrayList<>();
        args.add(String.valueOf(ENCRYPT_MODE.getMode()));
