...
public final class Messages {
    ...
    public static final String INPUT_SOURCE_ENCRYPT = String
            .format("Enter source (full path OR only filename OR Enter for %s) :", FILE_SOURCE);
    public static final String INPUT_DESTINATION_ENCRYPT = String
            .format("Enter destination (full path OR only filename OR Enter for %s) :", FILE_ENCRYPT);

    public static final String INPUT_SOURCE_DECRYPT = String.format(
            "Enter source (full path OR only filename OR Enter for %s) :",
            FILE_ENCRYPT);

    public static final String INPUT_DESTINATION_KEY = String
            .format("Enter destination (full path OR only filename OR Enter for %s) :", FILE_DECRYPT);

    public static final String INPUT_DESTINATION_BRUTEFORCE = String
            .format("Enter destination (full path OR only filename OR Enter for %s) :", FILE_BRUTEFORCE);
    ...
    public static final String INPUT_DESTINATION_ANALYZE = String
            .format("Enter destination (full path OR only filename OR Enter for %s) :", FILE_ANALYZE);
