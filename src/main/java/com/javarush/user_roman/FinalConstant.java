...
public class FinalConstant {
    ...
    private static final Path TEXT_PATH = Path.of("src/main/java/com/javarush/user_roman/text/test.txt");
    private static final String MENU_ACTION = "\t1-Запись текста в файл \n "
